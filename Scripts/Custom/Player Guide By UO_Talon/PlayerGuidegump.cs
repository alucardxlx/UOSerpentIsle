...
Your
Commands
Here", (bool)true, (bool)true);//......Add your command list here
            ...
            this.AddLabel(50, 95, 0, @"Client Patch:");
            this.AddLabel(155, 95, 0, @"");//......Detects Client Version  **Disabled, you must manually put it**
            this.AddLabel(50, 120, 0, @"Your Current Patch:");
            this.AddLabel(185, 120, 0, @"");//......Detects player patch  **Disabled, you must manually put it**
            this.AddLabel(50, 145, 0, @"Skillcap:");
            this.AddLabel(110, 145, 0, @"");//......Set Skillcap
            this.AddLabel(50, 170, 0, @"Statcap:");
            this.AddLabel(110, 170, 0, @"");//......Set Statcap
            this.AddLabel(50, 195, 0, @"Accounts per IP:");
            this.AddLabel(160, 195, 0, @"");//......Set Accounts pe IP limit
            ...
            Mobile m = sender.Mobile;
            {
                switch (info.ButtonID)
                {
                    case (int)Buttons.WebsiteButton1:
                        sender.LaunchBrowser("http://");//......Command List Url
                        break;

                    case (int)Buttons.WebsiteButton2:
                        sender.LaunchBrowser("http://");//......Shard Rules Url
                        break;

                    case (int)Buttons.WebsiteButton3:
                        sender.LaunchBrowser("http://");//......Shard Features Url
                        break;

                    case (int)Buttons.WebsiteButton4:
                        sender.LaunchBrowser("http://");//......Shard Donation Store Url
                        break;

                    case (int)Buttons.WebsiteButton5:
                        sender.LaunchBrowser("http://");//......Shard Updates Url
                        break;
                }
            }
        }
